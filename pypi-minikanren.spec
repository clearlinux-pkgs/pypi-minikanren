...
Source0  : https://files.pythonhosted.org/packages/3d/a2/6d34b2f971285392ed6c15d531110c60702d5b86b3296a742cb3793cc6a2/miniKanren-1.0.2.tar.gz
...
%prep
%setup -q -n miniKanren-1.0.2
cd %{_builddir}/miniKanren-1.0.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1640117099
...
cp %{_builddir}/miniKanren-1.0.2/LICENSE.txt %{buildroot}/usr/share/package-licenses/pypi-minikanren/e116414ac1a00c287445bcd5ff397fc71c5aec57
